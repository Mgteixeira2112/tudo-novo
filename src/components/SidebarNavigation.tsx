...
export const SidebarNavigation: React.FC<SidebarNavigationProps> = ({ onHome, onNavigate, onNavigatePage }) => {
  ...
  const groups: Group[] = [
    {
      ...
      items: [
        ...
        { label: 'Hospedagens vencidas', icon: AlertTriangle, page: 'overdueStays', allowed: canAccessTab('checkinout') },
  ...
  return (
    <div className="fixed inset-0 z-[70] pointer-events-none">
      ...
      <div
        className="absolute inset-y-3 left-3 flex items-start pointer-events-auto"
            ...
            <div className="flex items-center gap-1">
              ...
              {!collapsed && (
                <button
                  type="button"
                  onClick={collapseMenu}
                  className="rounded-xl p-2 text-[#DDE3D3] hover:bg-white/10"
                  aria-label="Recolher menu"
                >
                  <X className="h-5 w-5" />
                </button>
          ...
          <div className="relative z-20 ml-2 mt-20 w-[260px] rounded-2xl border border-[#DADFD1] bg-[#1F2638] p-3 text-white shadow-2xl">
            <div className="mb-2 flex items-center justify-between px-2 py-1">
              ...
              <button
                ...
                className="rounded-lg p-1.5 text-[#DDE3D3] hover:bg-white/10"
