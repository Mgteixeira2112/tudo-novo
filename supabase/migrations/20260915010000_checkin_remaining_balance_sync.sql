-- Reception: o check-in passa a considerar pagamentos já registrados para a reserva.
-- Evita cobrança acima do saldo e sincroniza payment_status pelo total acumulado pago.
